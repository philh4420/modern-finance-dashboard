        ...
        {goalsWithMetrics.length === 0 ? (
          ...
          <>
            ...
            <section className="goals-phase2-grid" aria-label="Goals intelligence">
              <article className="goals-phase2-card">
                <div className="goals-phase2-card__head">
                  <div>
                    <p className="panel-kicker">Phase 2</p>
                    <h3>At-risk goals</h3>
                  </div>
                  <span className={`pill ${atRiskGoals.length > 0 ? 'pill--warning' : 'pill--good'}`}>{atRiskGoals.length} flagged</span>
                </div>
                    ...
                    {atRiskGoals.slice(0, 4).map((goal) => (
                      <li key={`goal-risk-${goal._id}`}>
                        <div className="goals-alert-list__head">
                          ...
                          <span className={`pill ${goalStatus(goal) === 'overdue' ? 'pill--critical' : 'pill--warning'}`}>
              ...
              <article className="goals-phase2-card">
                <div className="goals-phase2-card__head">
                  ...
                  {optimizerRecommendations[0] ? <span className="pill pill--good">Top action</span> : null}
                </div>
                      ...
                      <li key={`goal-optimizer-${entry.goal._id}`}>
                        ...
                        <div className="goals-optimizer-list__body">
                          <div className="goals-optimizer-list__head">
                            ...
                            <span className={`pill ${index === 0 ? 'pill--good' : 'pill--neutral'}`}>Score {entry.score}</span>
                          </div>
                          <p>
              ...
              <article className="goals-phase2-card goals-phase2-card--tradeoff">
                <div className="goals-phase2-card__head">
                  <div>
                    <p className="panel-kicker">Phase 2</p>
                    <h3>Trade-off mode</h3>
                  </div>
                  <span className="pill pill--cadence">Side-by-side</span>
                </div>
                    ...
                    <div className="goals-tradeoff-grid">
                      ...
                      >
                        <div className="goals-tradeoff-card__head">
                          ...
                          {tradeoffComparison.recommendation === 'A' ? <span className="pill pill--good">Recommended</span> : null}
                        </div>
                        <p>
                      ...
                      >
                        <div className="goals-tradeoff-card__head">
                          ...
                          {tradeoffComparison.recommendation === 'B' ? <span className="pill pill--good">Recommended</span> : null}
                        </div>
                        <p>
	            ...
	            <section className="goals-phase3-grid" aria-label="Goals execution and reporting">
	              ...
	              <article className="goals-phase2-card">
	                <div className="goals-phase2-card__head">
	                  ...
	                  <span className={goalHealthPortfolio.avgHealth === null ? 'pill pill--neutral' : goalHealthPill(goalHealthPortfolio.avgHealth)}>
	                    ...
	                    {openGoals
	                      ...
	                      .map((goal) => (
	                        <li key={`goal-health-${goal._id}`}>
	                          <div className="goals-alert-list__head">
	                            <strong>{goal.title}</strong>
	                            <span className={goalHealthPill(goal.goalHealthScore)}>{goal.goalHealthScore}/100</span>
	                          </div>
	                          <p>
	              ...
	              <article className="goals-phase2-card">
	                <div className="goals-phase2-card__head">
	                  ...
	                  <span className="pill pill--neutral">{annualGoalReview.year}</span>
	                </div>
	                <div className="goals-phase2-summary-grid">
	                  <article>
	                    <p>Start funded</p>
	                      ...
	                      <li key={`goal-annual-${row.goal._id}`}>
	                        ...
	                        <div className="goals-optimizer-list__body">
	                          <div className="goals-optimizer-list__head">
	                            ...
	                            <span className={goalHealthPill(row.goal.goalHealthScore)}>{row.goal.goalHealthScore}/100</span>
	                          </div>
	                          <p>
	              ...
	              <article className="goals-phase2-card goals-phase3-card--wide">
	                <div className="goals-phase2-card__head">
	                  <div>
	                    <p className="panel-kicker">Phase 3</p>
	                    <h3>Goal event history</h3>
	                  </div>
	                  <span className="pill pill--neutral">{goalEvents.length} total events</span>
	                </div>
	                      ...
	                      <tbody>
	                        {recentGoalEvents.map((row) => (
	                          <tr key={`goal-event-${row.event._id}`}>
	                            ...
	                            <td>{row.title}</td>
	                            <td>
	                              <span className={goalEventTypePill(row.event.eventType)}>{goalEventTypeLabel(row.event.eventType)}</span>
	                            </td>
                          ...
                          {isEditing ? (
	                        ...
	                        <td>
	                          <div className="cell-stack">
	                            ...
	                            <span className={goalHealthPill(goal.goalHealthScore)}>Health {goal.goalHealthScore}/100</span>
